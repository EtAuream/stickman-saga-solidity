...
contract StixChef is OwnableUpgradeable {
    ...
    struct PoolInfo {
        ...
        uint256 accStixPerShare; // Accumulated stix per NFT, times 1e12. See below.
    }

    StixToken public stix;

    // giddy tokens created per second.
    uint256 public stixPerSecond;
    ...
    // Escrow that holds Stix rewards
    ...
    function pendingStix(uint256 _pid, address _user) external view returns (uint256) {
